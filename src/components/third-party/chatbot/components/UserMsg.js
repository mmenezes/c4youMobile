...
class UserMsg extends Component {
  ...
  render() {
    ...
    return (
      <div id={`msgNum-${msgNum}`} className="chtBot_wdth--100per chtBot_flt--left">
        <div className={usrMsgClasses.join(' ')}>
          {msgTxt}
          <span className="msgTimestamp chtBot_fntSz--9px chtBot_txtClr--gray chtBot_pddBtm--5px chtBot_pddTp--10px chtBot_dsply--block">
            {timestamp}
          </span>
        </div>
      </div>
